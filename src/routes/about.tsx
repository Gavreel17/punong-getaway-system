    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto max-w-3xl space-y-12 px-4 py-16">
        <div>
          ...
          <p className="mt-4 text-muted-foreground">Founded in the heart of BUBURAY, DIMATALING ZAMBOANGA DEL SUR, Punong Resort began as a small family beach house and has grown into a tranquil retreat for travelers from around the world. We blend handcrafted Filipino architecture with modern comforts to give every guest a stay to remember.</p>
        </div>
        <div>
