...
import { Database, ShieldCheck, Key } from "lucide-react";

export const Route = createFileRoute("/admin/login")({
  head: () => ({ meta: [{ title: "Admin Login — Punong Resort" }, { name: "description", content: "Administrator secure sign in." }] }),
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="flex flex-col items-center text-center space-y-2">
          <Link to="/" className="flex items-center gap-2 font-display text-3xl font-bold text-white hover:text-accent transition-colors">
            <ShieldCheck className="h-8 w-8 text-accent" /> Punong Admin
          </Link>
        ...
        <Card className="p-1 border-slate-800 bg-slate-900 shadow-2xl">
          <Tabs defaultValue="signin" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-slate-950 text-slate-400 border-b border-slate-800 p-0 h-12 rounded-t-lg rounded-b-none">
              <TabsTrigger value="signin" className="data-[state=active]:bg-slate-900 data-[state=active]:text-accent rounded-none rounded-tl-lg h-full">Sign In</TabsTrigger>
              <TabsTrigger value="signup" className="data-[state=active]:bg-slate-900 data-[state=active]:text-accent rounded-none rounded-tr-lg h-full">Register Admin</TabsTrigger>
            </TabsList>
            ...
            <div className="p-7">
                ...
                <form onSubmit={onSignIn} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input 
                      ...
                      className="bg-slate-950 border-slate-800 text-white focus:border-accent focus:ring-accent"
                    />
                  </div>
              ...
              <div className="relative flex py-6 items-center">
                ...
                <span className="flex-shrink mx-4 text-slate-500 text-xs uppercase tracking-wider">System</span>
                <div className="flex-grow border-t border-slate-800"></div>
              </div>
        ...
        <div className="text-center pt-2">
          <Link to="/" className="text-slate-500 hover:text-slate-300 text-sm transition-colors flex items-center justify-center gap-1.5">
