    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto grid max-w-5xl gap-8 px-4 py-16 md:grid-cols-2">
        <div className="space-y-4">
          <div className="flex items-start gap-3"><MapPin className="mt-1 h-5 w-5 text-accent" /><div><p className="font-semibold">Address</p><p className="text-sm text-muted-foreground">Coastal Road, BUBURAY, DIMATALING ZAMBOANGA DEL SUR</p></div></div>
